...
const MultiWeb3Provider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const signer = useCallback((auth: string) => {
    // console.group('multi')
